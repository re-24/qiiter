...
class HttpExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function exceptionProviderLevel400()
    {
        $headers = [
            'Rate-Limit' => 300,
            'Rate-Remaining' => 200,
    ...
    public function exceptionProviderLevel500()
    {
        $headers = [
            'Rate-Limit' => 300,
            'Rate-Remaining' => 200,
    ...
    public function exceptionMockCreate($statusCode, $headers = [], $responseBody = "")
    {
        $client = new Client();
    ...
    /**
     * @dataProvider exceptionProviderLevel400
     */
    public function testExceptionCauseRequestException($statusCode, $headers, $responseBody)
    {
        ...
        $client = $this->exceptionMockCreate($statusCode, $headers, $responseBody);
        try {
            $client->get('/');
        } catch (\Exception $ex) {
    ...
    /**
     * @dataProvider exceptionProviderLevel500
     */
    public function testExceptionCauseServerException($statusCode, $headers, $responseBody)
    {
        $this->setExpectedException(
            're24\Qiiter\Exception\HttpException',
     ...
     */
    public function testExceptionCauseTransferException()
    {
    ...
    {
        $client = $this->exceptionMockCreate(999);
        try {
            $client->get('/');
        } catch (\Exception $ex) {
